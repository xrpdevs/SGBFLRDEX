...
//import { routerv2 } from '../addresses.json';
...
export const LP_TOKEN_NAME = 'NEOSWAP LP';
export const LP_TOKEN_SYMBOL = 'NEOLP';
...
export const COOT = new Token(ChainId.MAINNET, '0xe4671844Fcb3cA9A80A1224B6f9A0A6c2Ba2a7d5', 18, 'COOT', 'Cootie Coin');
export const SFT = new Token(ChainId.MAINNET, '0xeC7a99eDb6995F98C17b316CE230AC8BC21B9d3b', 18, 'SFT', 'SGBFTSO RT');
export const CAND = new Token(ChainId.MAINNET, '0x70Ad7172EF0b131A1428D0c1F66457EB041f2176', 18, 'CAND', 'Canary Dollar');
...
export const ETH_NAME_AND_SYMBOL = {
  ...
  [ChainId.FLARE]: {"name": "Flare", "symbol": "FLR"},
  [ChainId.COSTON]: {"name": "Coston-Flare", "symbol": "CFLR"},
  [ChainId.SONGBIRD]: {"name": "Songbird", "symbol": "SGB"},
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.SONGBIRD]: [...WETH_ONLY[ChainId.SONGBIRD], COOT, SFT, CAND]
};
